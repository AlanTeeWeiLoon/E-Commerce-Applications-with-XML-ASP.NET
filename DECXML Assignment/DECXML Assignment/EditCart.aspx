<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="EditCart.aspx.cs" Inherits="DECXML_Assignment.EditCart" %>
...
<%--                                    <div class="btn_form">
                            ...
                            <div class="col-md-3-spe">
                                <div class="box-info-product">
                                    ...
                                    <asp:LinkButton ID="btnEditCart" Style="background: blue" class="exclusive" runat="server" OnClick="btnEditCart_Click"><span>Edit Cart</span></asp:LinkButton>
                                    <asp:LinkButton ID="btnDeleteCart" class="exclusive" runat="server" OnClick="btn_deleteCart_Click"><span>Delete Cart</span></asp:LinkButton>
                                </div>
                            </div>
                            </div>	
                        </ItemTemplate>
